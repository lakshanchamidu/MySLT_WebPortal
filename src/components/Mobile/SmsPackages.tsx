...
const smsBundles = [
  ...
  { name: "500 SMS", price: "Rs.149.00", validity: "14 Days" },
  { name: "Unlimited SMS", price: "Rs.249.00", validity: "30 Days" },
  { name: "Night SMS", price: "Rs.29.00", validity: "1 Night (10 PM - 6 AM)" },
  { name: "Weekend SMS", price: "Rs.89.00", validity: "Sat - Sun" },
  { name: "Work Hour SMS", price: "Rs.69.00", validity: "Mon - Fri (8 AM - 5 PM)" },
  { name: "Student SMS Pack", price: "Rs.59.00", validity: "5 Days" },
];
        ...
        <Box sx={{ width: '100%', maxWidth: '1300px', backgroundColor: colorScheme.primary, borderRadius: '12px', boxShadow: colorScheme.shadow, overflow: 'hidden', position: 'relative', p: 3 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 3, position: 'relative' }}>
            ...
            <Box sx={{ flex: 1, textAlign: 'center' }}>
              <Typography variant="body2" sx={{ fontWeight: 700, fontSize: '24px', color: colorScheme.accent }}>SMS Packages</Typography>
            </Box>
            <Box sx={{ width: '40px' }} />
          </Box>
